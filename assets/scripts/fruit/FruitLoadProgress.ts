...
@ccclass('FruitLoadProgress')
export class FruitLoadProgress extends Component {

    start() {
        director.preloadScene('FruitGame', function (completedCount, totalCount, item) {
